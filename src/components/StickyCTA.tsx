      ...
      {isVisible && (
        ...
        >
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/0 via-black to-black pointer-events-none h-32 -top-32" />
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-center md:text-left">
                      <div className="flex items-baseline gap-1 mb-1">
                        <span className="text-gray-400 text-sm line-through">$11,094</span>
