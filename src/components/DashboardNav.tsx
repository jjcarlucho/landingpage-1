...
const navigation = [
  ...
  { name: 'Mis Libros', href: '/dashboard/books' },
  { name: 'Bonos', href: '/dashboard/bonuses' },
...
const adminNavigation = [
  ...
  { name: 'Bonos', href: '/admin/bonuses' },
  { name: 'Estadísticas', href: '/admin/stats' },
];
          ...
          <Disclosure.Panel className="sm:hidden">
            ...
            <div className="border-t border-gray-200 pb-3 pt-4">
              <div className="flex items-center px-4">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-gray-800">{userData?.fullName}</div>
